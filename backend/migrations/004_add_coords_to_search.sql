-- Add master coordinates to search_services return
...
AS $$
    SELECT
        ...
        ST_Y(m.location::geometry) AS master_lat,
        ST_X(m.location::geometry) AS master_lon
    FROM services s
